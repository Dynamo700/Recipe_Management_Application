    ...
    if form.is_submitted():
        ...
        if os.path.exists(data_filename):
            ...
            if not df.empty:
                ...
                return render_template('search.html', form=form, notfound_message="Sorry, no recipes avaliable. Please come back later.")
        else:
            return render_template('search.html', form=form, notfound_message="Sorry, recipe doesn't exit")
